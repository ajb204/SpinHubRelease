...
"""
# def drawing_box(obj):
#     vbox2Lbl = wx.StaticBox(obj,-1,'Drawing:')
#     vbox2=wx.StaticBoxSizer(vbox2Lbl,wx.HORIZONTAL)

#     drawbutton = wx.Button(obj, -1, "Draw!", size=(-1,22))
#     cb_grid = wx.CheckBox(obj, -1,"Peaks",style=wx.ALIGN_RIGHT)
#     cb_calc = wx.CheckBox(obj, -1,"ShowCalc",style=wx.ALIGN_RIGHT)

#     obj.Bind(wx.EVT_BUTTON, on_draw_button, drawbutton)
#     obj.Bind(wx.EVT_CHECKBOX,on_draw_button)

#     vbox2.Add(cb_grid, border=10, flag=flags)
#     vbox2.Add(cb_calc, border=10, flag=flags)
#     vbox2.Add(drawbutton, border=10, flag=flags)
#     vbox2.AddSpacer(10)

# def contour_box(obj):
#     cntrLbl = wx.StaticBox(obj,-1,'Contours:')
#     cntrSizer=wx.StaticBoxSizer(cntrLbl,wx.HORIZONTAL)

#     text1=wx.StaticText(obj, -1, 'Min:')
#     text2=wx.StaticText(obj, -1, 'Factor:')
#     text3=wx.StaticText(obj, -1, 'Number:')
#     textbox0 = wx.TextCtrl(obj, size=(100,22), style=wx.TE_PROCESS_ENTER)
#     textbox1 = wx.TextCtrl(obj, size=(40,22), style=wx.TE_PROCESS_ENTER)
#     textbox2 = wx.TextCtrl(obj, size=(40,22), style=wx.TE_PROCESS_ENTER)

#     textbox0.SetValue(str(thresh))
#     textbox1.SetValue(str(1.2))
#     textbox2.SetValue(str(15))
#     border = 10
#     cntrSizer.Add(text1, 0, border=border, flag=flags)
#     cntrSizer.Add(textbox0, 0, border=border, flag=flags)
#     cntrSizer.Add(text2, 0, border=border, flag=flags)
#     cntrSizer.Add(textbox1, 0, border=border, flag=flags)
#     cntrSizer.Add(text3, 0, border=border, flag=flags)
#     cntrSizer.Add(textbox2, 0, border=border, flag=flags)
#     cntrSizer.AddSpacer(10)
