...
# James Eaton, 25/02/2025, University of Oxford
# This code will read in 1D, 2D and 3D NMRPipe data files and plot them
...
class SpinBore(wx.Frame):
    ...
    def read_bmrb(self):
        ...
        if(os.path.exists(file1)):
            free_data = open(file1, 'r')
            self.read_free(free_data)
        else:
